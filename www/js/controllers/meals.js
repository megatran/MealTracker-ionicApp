...
app.controller('MealCreateCtrl', function ($scope,
	...
	$scope.addPicture = function () {
		var options = {
			...
			//photolibrary in emulator only. If on real device, change to sourceType: Camera.PictureSourceType.CAMERA
		...
		$cordovaCamera.getPicture(options).then(function(imageData){
			...
			$ionicPopup.alert({
				...
				subTitle:'We had a problem trying to get that picture'
			});
		});
	};
